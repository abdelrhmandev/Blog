                ...
                <tbody class="text-gray-600 fw-bold">
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <a href="../../demo7/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <!--begin::User details-->
                            <div class="d-flex flex-column">
                                <a href="../../demo7/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
